...
<body>
    ...
    <h2 style= "text-align:center; margin-top: 20px; margin-bottom: 0px; font-family: 'KoHo'; font-weight: bold;
    color: white;  font-size: 40px">Curtas</h2>
    </div>
    ...
    <table class="table table-dark table-striped table-hover" style="background-color: black">
        <thead>
            ...
            <th scope="col">Concepção de Arte</th>
